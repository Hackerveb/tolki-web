// Minimum credits required to start a session (covers the minimum 3-second charge)
export const MIN_SESSION_CREDITS = 0.05;

// Interval in seconds at which credits are deducted during an active session
